...
foreach($pc in $computers){
    ...
    foreach($key in $subkeys){
        ...
        $array += $obj | where {$_.DisplayName -like "*APP*"} | Sort-Object -Descending

    } 

}

$array | Where-Object { $_.DisplayName } | select DisplayName, DisplayVersion, InstallDate, UninstallString | ft -auto
